<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="dataList">
      <el-table-column label="三字码" prop="code" width="100" align="center" />
      <el-table-column
        label="城市名称"
        prop="fullName"
        width="140"
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      listCityCode(this.queryParams).then((response) => {
      ...
      this.$refs["form"].validate((valid) => {
        if (valid) {
          if (this.form.id) {
            ...
            updateCityCode(this.form).then((response) => {
              this.msgSuccess("修改成功");
              this.open = false;
              this.getList();
            });
          } else {
            addCityCode(this.form).then((response) => {

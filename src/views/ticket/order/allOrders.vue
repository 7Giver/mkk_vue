<template>
  ...
  <div class="all-orders">
    ...
    >
      ...
      >
        <template slot-scope="scope">
          <div class="mix-item" v-for="(item, idx) in scope.row.orderMsg">
            {{ item }}
          </div>
        </template>
      </el-table-column>
      ...
      <el-table-column label="操作" align="center" fixed="right">
        <template slot-scope="scope">
          <el-button
            ...
            v-if="scope.row.handleStatus != 1 && scope.row.handleStatus != 2"
          >
            锁单
          </el-button>
          <el-button
            ...
            v-if="scope.row.handleStatus == 1 && scope.row.operator == account"
          >
            解锁
          </el-button>
          <el-button
    ...
    async getList() {
      ...
      if (dataList.length) {
        ...
        dataList.forEach((item) => {
          ...
          item.orderMsg = [item.airlineCode, item.tripTypeDes];

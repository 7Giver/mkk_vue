...
<!--      <el-table-column label="角色编号" prop="id" width="120" />-->
      <el-table-column label="角色名称" prop="fullName" :show-overflow-tooltip="true" width="150" />
      <el-table-column label="显示顺序" prop="sortCode" width="100" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="角色名称" prop="fullName">
          <el-input v-model="form.fullName" placeholder="请输入角色名称" />
        </el-form-item>
        <el-form-item label="角色顺序" prop="sortCode">
...
export default {
  ...
  methods: {
    ...
    handleStatusChange(row) {
      ...
      this.$confirm('确认要"' + text + '""' + row.fullName + '"角色吗?', "警告", {
    ...
    handleUpdate(row) {
      ...
      this.getMenuTreeselect().then(res=>{
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除角色编号为"' + fullNames + '"的数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {

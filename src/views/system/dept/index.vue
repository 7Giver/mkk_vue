<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="fullName" label="部门名称" width="260"></el-table-column>
      <el-table-column prop="sortCode" label="排序" width="200"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    // /** 根据parentId获取parentDeptName */
    // gainParentDeptName(parentId){
    ...
    // },
      // 获取当前选中部门的名称
      selectDepart(val) {
          this.form.parentDeptName = val.fullName
      },
    /** 搜索按钮操作 */
    handleQuery() {
      this.getList();
    ...
    submitForm: function() {
      this.$refs["form"].validate(valid => {
        if (valid) {
            ...
            // }
          if (this.form.id !== '') {
            // this.gainParentDeptName(this.form.parentId).then(res=>{
            //     this.form.parentDeptName = res
